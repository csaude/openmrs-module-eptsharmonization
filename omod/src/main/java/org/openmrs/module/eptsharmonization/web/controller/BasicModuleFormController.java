 ...
 */
@Controller
@RequestMapping(value = "module/eptsharmonization/eptsharmonizationLink.form")
public class BasicModuleFormController {
  ...
  private final String SUCCESS_FORM_VIEW = "/module/eptsharmonization/eptsharmonizationForm";
