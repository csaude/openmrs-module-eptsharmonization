...
@Component
public class HarmonizePatientIdentifierTypeDelegate {
  ...
  public void setHarmonizationEncounterTypeService(
      HarmonizationPatientIdentifierTypeService harmonizationEncounterTypeService) {
    this.harmonizationPatientIdentifierTypeService = harmonizationEncounterTypeService;
  }

  public static List<String> SUMMARY_EXECUTED_SCENARIOS = new ArrayList<>();
  public static List<PatientIdentifierType> EXECUTED_PATIENTIDENTIFIERTYPES_MANUALLY_CACHE =
      new ArrayList<>();
  ...
  public void setHarmonizationStage(
    ...
    PATIENT_IDENTIFIER_TYPES_NOT_PROCESSED.removeAll(
        EXECUTED_PATIENTIDENTIFIERTYPES_MANUALLY_CACHE);
  ...
  private void updateProductionToExportList(HarmonizationData productionItemsToExport) {
    ...
    List<HarmonizationItem> itemsToRemove =
        getConvertedData(
                DTOUtils.fromPatientIdentifierTypes(EXECUTED_PATIENTIDENTIFIERTYPES_MANUALLY_CACHE))
            .getItems();
  ...
  private void setSwappableDataClones(
    ...
    swappablePatientIdentifierTypes.removeAll(EXECUTED_PATIENTIDENTIFIERTYPES_MANUALLY_CACHE);
