...
public class HarmonizeExportPersonAttributeTypesController {

  @RequestMapping(
      value = "/module/eptsharmonization/harmonizeExportPersonAttributeTypes",
  ...
  public HarmonizationData getHarmonizationModel() {
    ...
    List<PersonAttributeTypeDTO> data =
        HarmonizationUtils.getHarmonizationPersonAttributeTypeService()
            .findAllProductionPersonAttibuteTypesNotInMetadataServer();

    for (PersonAttributeTypeDTO pesonAttributeTypeDTO : data) {
      items.add(new HarmonizationItem(pesonAttributeTypeDTO.getUuid(), pesonAttributeTypeDTO));
    }
