<c:if
	...
	<c:if test="${not empty notSwappableEncounterTypesClone}">
		<br />

		<c:if test="${not empty mdsEncounterTypeNotHarmonizedYet}">
			<fieldset>
				<legend>
					<b> <spring:message
				...
				<table cellspacing="0" border="0" style="width: 100%">
					...
					<form method="post" action="addEncounterTypeFromMDSMapping.form">
						<tr>
							<td colspan="3" style="text-align: center; width: 45%;"><spring:bind
									path="harmonizationItem.value">
									<select name="${status.expression}">
										<option value="">Selecione</option>
										<c:forEach items="${mdsEncounterTypeNotHarmonizedYet}"
											var="type">
		...
		<c:if test="${not empty swappableEncounterTypes}">
			<fieldset>
				<legend>
				...
				<table cellspacing="0" border="0" style="width: 100%">
					<tr>
						<th colspan="3" style="text-align: center; width: 45%;"><spring:message
								code="eptsharmonization.encounterType.copiedFrom.metadataServer" /></th>
						<th colspan="3" style="text-align: center; width: 45%;"><spring:message
								code="eptsharmonization.encounterType.created.OnProductionServer" /></th>
						<th colspan="2" style="text-align: left; width: 10%;"></th>
					</tr>
