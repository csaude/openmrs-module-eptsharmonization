...
<openmrs:require privilege="Manage Encountery Types"
	otherwise="/login.htm"
	redirect="/module/eptsharmonization/harmonizeDeleteEncounterTypes.form" />
				...
				<td colspan="6">
					<div class="submit-btn" align="center">
						<input type="button"
							...
							name="previous" />
						<input type="submit"
							value='<spring:message code="eptsharmonization.encountertype.btn.removeNewFromPDS"/>'
							name="deleteEncounterTypes" />
					</div>
				</td>
			</tr>
		</table>
