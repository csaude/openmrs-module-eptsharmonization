	...
	<c:if test="${not empty differentIDsAndEqualUUID.items}">
		<springform:form modelAttribute="differentIDsAndEqualUUID"
			...
			<b class="boxHeader"><spring:message
					code="eptsharmonization.programworkflow.harmonize.differentID.andEqualUUID" /></b>
			<fieldset>
				<table cellspacing="0" border="0" style="width: 100%">
					<tr>
						...
						<th style="text-align: left; width: 15%;"><spring:message
								code="eptsharmonization.programworkflow.mdserver.program" /></th>
						<th style="text-align: left; width: 15%;"><spring:message
								code="eptsharmonization.programworkflow.mdserver.concept" /></th>
						<th style="text-align: left; width: 5%;"><spring:message
								code="eptsharmonization.encountertype.pdserver.id" /></th>
						<th style="text-align: left; width: 15%;"><spring:message
								code="eptsharmonization.programworkflow.pdserver.program" /></th>
						<th style="text-align: left; width: 15%;"><spring:message
								code="eptsharmonization.programworkflow.pdserver.concept" /></th>
					...
					<c:forEach var="item" items="${differentIDsAndEqualUUID.items}"
						...
						<tr class="confirm-each-row-harmonization">
							<td valign="top" style="text-align: left; width: 5%;">${item.value[0].programWorkflow.id}</td>
							<td valign="top" style="text-align: left; width: 15%;">${item.value[0].program}</td>
							<td valign="top" style="text-align: left; width: 15%;">${item.value[0].concept}</td>
							<td valign="top" style="text-align: left; width: 5%;">${item.value[1].programWorkflow.id}</td>
							<td valign="top" style="text-align: left; width: 15%;">${item.value[1].program}</td>
