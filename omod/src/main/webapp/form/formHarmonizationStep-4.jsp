<c:if
	...
	<form method="post" class="box" action="harmonizeFormExportForms.form">
					...
					<tr>
						<td colspan="3" style="text-align: center; width: 45%;"><spring:bind
								...
								<select name="${status.expression}">
									...
									<c:forEach items="${mdsFormNotHarmonizedYet}" var="type">
							...
							<td colspan="2">
								<div class="submit-btn" align="left">
									<input type="hidden" id="${item.key.uuid}"
										name="productionServerFormUuID" value="${item.key.uuid}" /> <input
										type="submit" id="${item.key.uuid}"
