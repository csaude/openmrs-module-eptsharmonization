	...
	<c:if test="${not empty differentIDsAndEqualUUID.items}">
		<springform:form modelAttribute="differentIDsAndEqualUUID"
			...
			<b class="boxHeader"><spring:message
					code="eptsharmonization.programworkflowstate.harmonize.differentID.andEqualUUID" /></b>
			<fieldset>
				<table cellspacing="0" border="0" style="width: 100%">
					<tr>
						...
						<th style="text-align: left; width: 5%;"><spring:message
								code="eptsharmonization.programworkflowstate.harmonize.conceptStateConversions" /></th>
						<th style="text-align: left; width: 5%;"><spring:message
					...
					<c:forEach var="item" items="${differentIDsAndEqualUUID.items}"
						...
						<tr class="confirm-each-row-harmonization">
							<td valign="top" style="text-align: left; width: 5%;">${item.value[0].programWorkflowState.id}</td>
							<td valign="top" style="text-align: left; width: 15%;">${item.value[0].concept}</td>
							<td valign="top" style="text-align: left; width: 15%;">${item.value[0].flowConcept}</td>
							<td valign="top" style="text-align: left; width: 15%;">${item.value[0].flowProgram}</td>
							<td valign="top" style="text-align: left; width: 5%;">${item.value[1].programWorkflowState.id}</td>
							<td valign="top" style="text-align: left; width: 15%;">${item.value[1].concept}</td>
							<td valign="top" style="text-align: left; width: 15%;">${item.value[1].flowConcept}</td>
							<td valign="top" style="text-align: left; width: 15%;">${item.value[1].flowProgram}</td>
