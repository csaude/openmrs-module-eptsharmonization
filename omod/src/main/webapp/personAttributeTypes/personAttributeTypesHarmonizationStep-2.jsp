				...
				<table cellspacing="0" border="0" style="width: 100%">
					...
					<c:forEach var="item" items="${differentIDsAndEqualUUID.items}"
						...
						<tr class="confirm-each-row-harmonization">
							<td valign="top" style="text-align: left; width: 5%;">${item.value[0].personAttributeType.id}</td>
							<td valign="top" style="text-align: left; width: 15%;">${item.value[0].personAttributeType.name}</td>
							<td valign="top" style="text-align: left; width: 15%;">${item.value[0].personAttributeType.description}</td>
							<td valign="top" style="text-align: left; width: 5%;">${item.value[1].personAttributeType.id}</td>
							<td valign="top" style="text-align: left; width: 15%;">${item.value[1].personAttributeType.name}</td>
							<td valign="top" style="text-align: left; width: 15%;">${item.value[1].personAttributeType.description}</td>
