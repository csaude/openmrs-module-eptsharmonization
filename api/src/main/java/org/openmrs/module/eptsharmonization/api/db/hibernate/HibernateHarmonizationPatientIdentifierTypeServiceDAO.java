...
public class HibernateHarmonizationPatientIdentifierTypeServiceDAO
  ...
  public List<PatientIdentifier> findPatientIdentifiersByPatientIdentifierTypeId(
    ...
    final Query query =
        this.sessionFactory
            .getCurrentSession()
            .createSQLQuery(
                "select p.* from patient_identifier p where p.patient_identifier_type_id="
  ...
  public PatientIdentifierType updatePatientIdentifierType(
    ...
    this.sessionFactory
        .getCurrentSession()
        .createSQLQuery(
            "update patient_identifier_type set patient_identifier_type_id =:nextId, swappable =:swappable where patient_identifier_type_id =:patientIdentifierTypeIde ")
  ...
  public void updatePatientIdentifier(
    ...
    this.sessionFactory
        .getCurrentSession()
        .createSQLQuery(
            "update patient_identifier set patient_identifier_type_id =:patientIdentifierTypeId where patient_identifier_id =:patientIdentifierId")
