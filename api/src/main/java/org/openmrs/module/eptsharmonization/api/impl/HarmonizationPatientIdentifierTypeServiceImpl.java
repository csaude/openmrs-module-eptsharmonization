...
public class HarmonizationPatientIdentifierTypeServiceImpl extends BaseOpenmrsService
  ...
  public void saveWithDifferentNames(
    ...
    for (String key : patientIdentifierTypes.keySet()) {
      ...
      PatientIdentifierTypeDTO mdsPatientIdentifierType = list.get(0);
      PatientIdentifierTypeDTO pdsPatientIdentifierType = list.get(1);
      PatientIdentifierType patientIdentifierType =
          this.patientService.getPatientIdentifierType(
              pdsPatientIdentifierType.getPatientIdentifierType().getId());
      patientIdentifierType.setName(mdsPatientIdentifierType.getPatientIdentifierType().getName());
      patientIdentifierType.setDescription(
          mdsPatientIdentifierType.getPatientIdentifierType().getDescription());
