...
public class HibernateHarmonizationFormServiceDAO implements HarmonizationFormServiceDAO {
	...
	//
	// @Autowired
	// public void setHarmonizationServiceDAO(HarmonizationServiceDAO
	// harmonizationServiceDAO) {
	...
	public Form updateForm(Integer nextId, Form form, boolean swappable) throws DAOException {
		this.sessionFactory.getCurrentSession()
				.createSQLQuery(String.format("update form set form_id =%s, swappable =%s where form_id =%s ", nextId,
						swappable, form.getId()))
				.executeUpdate();
	...
	public void saveNotSwappableForm(Form form) throws DAOException {
		String insert = String.format(
				...
				form.getId(), form.getName(), form.getVersion(), form.getBuild(), form.getPublished(),
				form.getDescription(), form.getEncounterType().getId(), Context.getAuthenticatedUser().getId(),
				form.getDateCreated(), form.getRetired(), form.getUuid(), false);
